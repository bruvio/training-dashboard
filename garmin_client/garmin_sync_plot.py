...
def plot_wellness_data_range(start_date: str, end_date: str, 
                            aggregate: str = "none",
                            save_dir: str = "./plots",
    ...
    for key, df in data.items():
        ...
        plot_results["data_summary"][key] = {
            "total_rows": len(df_processed),
            "non_null_counts": nonnull_counts
        }
...
def main():
    ...
    p.add_argument("--enhanced", action="store_true",
                   help="Use enhanced plotting with subplots and trend lines")
    p.add_argument("--plot-types", nargs="*",
