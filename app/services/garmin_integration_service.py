...
class GarminIntegrationService:
    ...
    def authenticate_garmin(self, email: Optional[str] = None, password: Optional[str] = None) -> Dict[str, Any]:
        ...
        if not BRUVIO_GARMIN_AVAILABLE:
            return {
                "success": False,
                "error": "bruvio-garmin script not available"
            }
    ...
    def sync_wellness_data_range(self, start_date: date, end_date: date, 
                                smoothing: str = "none") -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if not dailies:
                return {
                    "success": False,
                    "error": "No data retrieved from Garmin Connect"
                }
    ...
    def _aggregate_records(self, records: List[Dict[str, Any]], period_date: date) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            sum_fields = [
                "total_sleep_time_s", "deep_sleep_s", "light_sleep_s", "rem_sleep_s", "awake_time_s",
                "total_steps", "total_distance_m", "calories_burned", "calories_bmr", "calories_active",
                "floors_climbed", "rest_minutes", "low_minutes", "medium_minutes", "high_minutes"
            ]
            
            avg_fields = [
                "sleep_score", "efficiency_percentage", "restlessness", "avg_stress_level", 
                "max_stress_level", "rest_stress_level", "resting_hr", "max_hr", "avg_hr",
                "hrv_score", "body_battery_score", "charged_value", "drained_value", 
