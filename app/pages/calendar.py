    ...
    return dbc.Container([
                ...
                dbc.Row([
                    ...
                    dbc.Col([
                        ...
                        dbc.InputGroup([
                            ...
                            ], id="search-button", outline=True, color="secondary", size="sm")
                        ])
                    ], lg=3, md=6, sm=12),
                    ...
                    dbc.Col([
                        ...
                        dbc.ButtonGroup([
                            dbc.Button("This Week", id="btn-week", size="sm", outline=True, color="primary"),
                            dbc.Button("This Month", id="btn-month", size="sm", outline=True, color="primary"),
                            dbc.Button("Last 30 Days", id="btn-30days", size="sm", outline=True, color="primary"),
                            dbc.Button("This Year", id="btn-year", size="sm", outline=True, color="primary")
                        ], size="sm")
                    ], lg=2, md=6, sm=12)
                ], className="g-3")
            ])
        ...
        dbc.Row([
            ...
            dbc.Col([
                dbc.Card([
                    dbc.CardBody([
                        html.H4(id="total-distance", children="0 km", className="text-success mb-1"),
            ...
            dbc.Col([
                dbc.Card([
                    dbc.CardBody([
                        html.H4(id="elevation-gain", children="0 m", className="text-secondary mb-1"),
                        ...
                        dash_table.DataTable(
                            ...
                            columns=[
                                ...
                                },
                                {
                                    ...
                                    "id": "distance_km",
                                    "type": "numeric",
                                    "format": dash_table.Format(precision=2, scheme=dash_table.Scheme.fixed)
                                },
                                {
                                    "name": "⏱️ Duration", 
                                    "id": "duration_str"
                    ...
                    dbc.CardBody([
                        html.Div([
                            ...
                            html.P([
                                ...
                                html.A("import some activities", href="#", className="text-primary"),
                                " to get started."
